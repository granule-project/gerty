...
--     the "Language.Gerty.Syntax.Parser.Parser" to get the next token from the input.
-- -}
--
{
module Language.Gerty.Syntax.Lexer
  ( lexer
    -- * Lex states
  , normal, code
...
import Language.Gerty.Syntax.Parser.Comments
import {-# SOURCE #-} Language.Gerty.Syntax.Parser.Layout
...
-- by Language.Gerty.Syntax.Parser.LexActions.foolAlex in a preprocessing pass.
...
<0,code> "<"            { symbol SymOpenAngle }
<0,code> ">"            { symbol SymCloseAngle }
