...
module Language.Gerty.Syntax.Abstract
  (
   -- * Expressions
    Expr(..)
  , Name(..)
...
import Language.Gerty.Syntax.Common hiding (Arg)
import qualified Language.Gerty.Syntax.Common as Com
import qualified Language.Gerty.Syntax.Common.Language as Com
