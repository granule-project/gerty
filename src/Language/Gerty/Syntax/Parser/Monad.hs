...
module Language.Gerty.Syntax.Parser.Monad
    ( -- * The parser monad
      Parser
    , ParseResult(..)
    , ParseState(..)
...
--   "Language.Gerty.Syntax.Parser.Layout" for more informaton.
...
-- | The most general way of parsing a string. The "Language.Gerty.Syntax.Parser" will define
