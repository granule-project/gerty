...
module Language.Gerty.Syntax.Translation.ConcreteToAbstract
  ( ToAbstract(..)
  ) where
...
import Language.Gerty.Substitution (fresh)
import Language.Gerty.Syntax.Common
import Language.Gerty.Syntax.Common.Language (typeOf)
import qualified Language.Gerty.Syntax.Abstract as A
import qualified Language.Gerty.Syntax.Concrete as C
import Language.Gerty.Scoping.Monad
import Language.Gerty.Scoping.Scope
import Language.Gerty.Util.Pretty (pprintShow)
