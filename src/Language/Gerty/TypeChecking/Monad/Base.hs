...
module Language.Gerty.TypeChecking.Monad.Base
  (
   -- * Type checker monad
   CM
...
import qualified Language.Gerty.Scoping.Monad.Exception as SE
...
import Language.Gerty.Syntax.Parser.Monad (ParseError)
