...
-}
module Language.Dlam.Syntax.Parser.LexActions
    ( -- * Main function
      lexToken
      -- * Lex actions
      -- ** General actions
...
'Language.Dlam.Syntax.Parser.Lexer.alexScanUser'. This is the main lexing function
where all the work happens. The function 'Language.Dlam.Syntax.Parser.Lexer.lexer',
...
-- | Executed for layout keywords. Enters the 'Language.Dlam.Syntax.Parser.Lexer.layout'
